...
export const currentResult = decompileResultPipeline(hytaleJar);
export function decompileResultPipeline(jar: Observable<HytaleJar>): Observable<DecompileResult> {
